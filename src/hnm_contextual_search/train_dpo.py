#!/usr/bin/env python3
"""
DPO Training Script for Fashion Recommendation
Usage: python train_dpo_model.py --model qwen-7b --dataset data/hnm/dpo_dataset.jsonl
"""
...
class UserProfileDPOTrainer:
    def __init__(self, dataset_path="data/hnm/dpo_dataset.jsonl", sft_checkpoint_path = None):
        self.dataset_path = dataset_path
        self.base_output_dir = "./trained_dpo_models"
    ...
    def create_dpo_config(self, config, output_dir):
        ...
        return DPOConfig(
            ...
            save_steps=10,  # Save less frequently for DPO
            logging_steps=1,
            eval_steps=10,
    ...
    def train_model(self, model_key):
        ...
        try:
            ...
            del trainer, model, ref_model, tokenizer
...
def main():
    ...
    parser.add_argument(
        "--dataset", 
        type=str, 
        default="data/hnm/dpo_dataset.jsonl",
    ...
    parser.add_argument(
        ...
        type=str, 
        default=None,
        help="Path to SFT checkpoint for DPO initialization (optional)"
    )
    
    args = parser.parse_args()
    
    trainer = UserProfileDPOTrainer(
